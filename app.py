...
#Sidebar
st.sidebar.image("tiktok.png", use_column_width=False,width=250)
...
st.sidebar.markdown("<div> <h1 style='display:inline-block;allign:center'>TikTok Analytics</h1> </div> ",unsafe_allow_html=True)
